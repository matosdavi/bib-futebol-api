...
INSERT IGNORE INTO stadium (id, name, city, state, active) VALUES ('10000000-0000-0000-0000-000000000001', 'Neo Química Arena', 'São Paulo', 'SP', true);
INSERT IGNORE INTO stadium (id, name, city, state, active) VALUES ('10000000-0000-0000-0000-000000000002', 'Maracanã', 'Rio de Janeiro', 'RJ', true);
INSERT IGNORE INTO stadium (id, name, city, state, active) VALUES ('10000000-0000-0000-0000-000000000003', 'Mineirão', 'Belo Horizonte', 'MG', true);

-- Inserts para Times (Clubs)
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000001', 'Corinthians', 'SP', '1910-09-01', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000002', 'Palmeiras', 'SP', '1914-08-26', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000003', 'São Paulo', 'SP', '1930-01-25', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000004', 'Flamengo', 'RJ', '1895-11-17', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000005', 'Vasco da Gama', 'RJ', '1898-08-21', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000006', 'Atlético Mineiro', 'MG', '1908-03-25', true);
INSERT IGNORE INTO club (id, name, state, foundation_date, active) VALUES ('20000000-0000-0000-0000-000000000007', 'Cruzeiro', 'MG', '1921-01-02', true);

-- Inserts para Partidas (Matches)
INSERT IGNORE INTO `match` (id, home_club_id, away_club_id, stadium_id, home_club_goals, away_club_goals, match_date_time)
